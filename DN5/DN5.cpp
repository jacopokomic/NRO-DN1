...
#pragma omp for
    ...
    std::cout << "Trajanje Gauss-Seidelove metode: " << time_duration.count() << " sekund" << std::endl;
    ...
    std::cout << "Serijski cas: " << time_duration.count() << " sekund" << std::endl;
    cout << "Maksimalna temperatura: " << max_T << " stopinj Celzija" << endl;
